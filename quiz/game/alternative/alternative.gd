...
#  [CONSTANTS]
var CHECKER_TEXTURE_INCORRECT: StreamTexture = preload("res://assets/themes/default/incorrect.png")
var CHECKER_TEXTURE_CORRECT: StreamTexture = preload("res://assets/themes/default/correct.png")
